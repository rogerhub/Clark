...
class Account < ActiveRecord::Base
  ...
  def picturepath
    if FileTest.exists?(Rails.public_path + "/pictures/"+id.to_s+".jpg")
      "/pictures/#{id}.jpg"
    elsif FileTest.exists?(Rails.public_path + "/pictures/"+id.to_s+".png")
      "/pictures/#{id}.png"
    else
  ...
  def haspicture
    if FileTest.exists?(Rails.root + "/public/pictures/"+id.to_s+".jpg") || FileTest.exists?(Rails.root + "/public/pictures/"+id.to_s+".png")
      true
    else
      false
    end
